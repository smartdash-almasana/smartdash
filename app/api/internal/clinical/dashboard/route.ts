...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        if (refresh) {
            console.info(JSON.stringify({ level: "info", msg: "Dashboard refresh triggered", seller_id: sellerId }));
            ...
            if (snapshots) {
                ...
                console.warn(JSON.stringify({ level: "warn", msg: "Refresh failed: Snapshots not available", seller_id: sellerId }));
            }
        }
