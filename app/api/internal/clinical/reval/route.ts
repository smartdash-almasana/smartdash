...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        console.info(JSON.stringify({ level: "info", msg: `Individual reval started for ${sellerId}`, seller_id: sellerId }));
        ...
        if (!snapshots) {
            console.warn(JSON.stringify({ level: "warn", msg: `Could not load snapshots for ${sellerId}`, seller_id: sellerId }));
